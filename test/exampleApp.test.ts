...
describe('example app', () => {
  ...
  it('wires an iOS host-app smoke runner for native JPEG/PNG/GIF/WebP/HEIC/HEIF/AVIF MVP validation', () => {
    ...
    expect(appSource).toContain('readJpegMetadataSummary');
    expect(appSource).toContain('IOS_JPEG_SOURCE_EXIF_WIDTH');
    expect(appSource).toContain('IOS_JPEG_SOURCE_EXIF_HEIGHT');
    expect(appSource).toContain('Expected source JPEG TIFF orientation 6');
    expect(appSource).toContain('Expected source JPEG EXIF dimensions');
    expect(appSource).toContain('Expected preserved JPEG orientation metadata 1/1');
    expect(appSource).toContain('Expected preserved JPEG pixel metadata');
    expect(appSource).toContain('Expected preserved JPEG EXIF dimensions');
    ...
    expect(iosModuleSource).toContain('readJpegMetadataSummary');
    ...
    expect(iosModuleSource).toContain('ExampleImageSourceReadJpegMetadataSummary');
    expect(iosModuleSource).toContain('ExampleImageSourceNumberValue');
    expect(iosModuleSource).toContain('kCGImagePropertyPixelWidth');
    expect(iosModuleSource).toContain('kCGImagePropertyPixelHeight');
    expect(iosModuleSource).toContain('kCGImagePropertyOrientation');
    expect(iosModuleSource).toContain('kCGImagePropertyTIFFOrientation');
    expect(iosModuleSource).toContain('kCGImagePropertyExifDictionary');
    expect(iosModuleSource).toContain('kCGImagePropertyExifPixelXDimension');
    expect(iosModuleSource).toContain('kCGImagePropertyExifPixelYDimension');
