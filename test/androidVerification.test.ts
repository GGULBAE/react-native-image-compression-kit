...
describe('Android verification scripts', () => {
  it('declares the v0.2.53 candidate and current npm metadata', () => {
    ...
    expect(packageJson.version).toBe('0.2.53');
    ...
    expect(readmeSource).toContain(
      'Version `0.2.53` is the unpublished GitHub Action pin update provenance and manual review gate candidate.'
    );
    expect(readmeSource).toContain(
    ...
    expect(readmeSource).toContain(
      'The repository package metadata is `0.2.53` for the unpublished GitHub Action pin update provenance and manual review gate candidate. npm `latest` remains `0.2.50`.'
    );
    expect(readmeSource).toContain(
  ...
  it('documents the v0.2.53 Action pin provenance candidate and previous release notes', () => {
