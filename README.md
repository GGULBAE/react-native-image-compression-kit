...
<p align="center">
  <img alt="Status: v0.2.11 docs-only correction" src="https://img.shields.io/badge/Status-v0.2.11%20docs--only-blue" />
...
Version `0.2.11` is a docs-only npm README correction for `react-native-image-compression-kit`. It keeps Android and iOS runtime behavior unchanged from `0.2.10` while publishing a package README that no longer carries the stale `0.2.10` release-ready/pre-publish status shipped in the `0.2.10` tarball. The latest published npm package is `0.2.11`, with GitHub Release [v0.2.11](https://github.com/GGULBAE/react-native-image-compression-kit/releases/tag/v0.2.11).
