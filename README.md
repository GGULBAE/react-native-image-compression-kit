...
<p align="center">
  <img alt="Status: v0.2.10 release-ready" src="https://img.shields.io/badge/Status-v0.2.10%20release--ready-blue" />
...
Version `0.2.10` is release-ready for `react-native-image-compression-kit`. It adds capability-gated iOS AVIF input through ImageIO static decode while keeping AVIF output, animated AVIF preservation, HEIC/HEIF output, iOS metadata preservation, cancellation, and progress outside this release. It has not been published to npm yet; until that publish happens, the latest published npm package remains `0.2.9`, with GitHub Release [v0.2.9](https://github.com/GGULBAE/react-native-image-compression-kit/releases/tag/v0.2.9).
