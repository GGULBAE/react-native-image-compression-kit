...
<p align="center">
  <img alt="Status: v0.2.13 published" src="https://img.shields.io/badge/Status-v0.2.13%20published-blue" />
...
Version `0.2.13` is published for `react-native-image-compression-kit`. It hardens iOS `metadata: 'preserve'` for JPEG source to JPEG output by normalizing preserved orientation and pixel dimension metadata after resize and `output.maxBytes` paths. The latest published npm package is `0.2.13`, with GitHub Release [v0.2.13](https://github.com/GGULBAE/react-native-image-compression-kit/releases/tag/v0.2.13).
