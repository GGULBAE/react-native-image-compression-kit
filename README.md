...
<p align="center">
  <img alt="Status: v0.2.47 release" src="https://img.shields.io/badge/Status-v0.2.47%20release-green" />
...
The package README uses registry-independent v0.2.47 release wording so the same tarball remains accurate before and after npm publication. Git tags and GitHub Releases are managed separately and are not implied by this package status.
...
For v0.2.47, run the registry-based smoke test after npm publication:
