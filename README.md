...
<p align="center">
  <img alt="Status: v0.2.12 published" src="https://img.shields.io/badge/Status-v0.2.12%20published-blue" />
...
Version `0.2.12` is published for `react-native-image-compression-kit`. It adds iOS `metadata: 'preserve'` support for the narrow JPEG source to JPEG output path. The latest published npm package is `0.2.12`, with GitHub Release [v0.2.12](https://github.com/GGULBAE/react-native-image-compression-kit/releases/tag/v0.2.12).
