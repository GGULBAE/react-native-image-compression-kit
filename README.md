...
<p align="center">
  <img alt="Status: v0.2.43 candidate" src="https://img.shields.io/badge/Status-v0.2.43%20candidate-yellow" />
...
The CI replay fixture provenance coverage pins workflow `iOS Validation`, run `28928015548`, head SHA `c6981c3b6b06e5e6e34f42147a94e4299a0f82b2`, job, step, timestamp, and source URL alongside the replayed PASS line.
