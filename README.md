...
<p align="center">
  <img alt="Status: v0.2.8 published" src="https://img.shields.io/badge/Status-v0.2.8%20published-brightgreen" />
...
This repository publishes `react-native-image-compression-kit@0.2.8` as the current npm `latest` dist-tag, with GitHub Release [v0.2.8](https://github.com/GGULBAE/react-native-image-compression-kit/releases/tag/v0.2.8). Version `0.2.8` keeps Android and iOS runtime behavior unchanged while adding a repeatable post-publish npm registry smoke script for registry tarball inspection and clean consumer install/typecheck validation. The TypeScript API contract, React Native Codegen spec, Android native module, Android example app, iOS native module, unit test foundation, and npm package metadata are in place.
