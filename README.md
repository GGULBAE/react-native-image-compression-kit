...
<p align="center">
  <img alt="Status: v0.2.18 published" src="https://img.shields.io/badge/Status-v0.2.18%20published-brightgreen" />
...
Version `0.2.18` is published as a docs-only npm README correction for `react-native-image-compression-kit`. It keeps Android and iOS runtime behavior unchanged while replacing the npm package-page README that carried stale `0.2.17` pre-publish candidate wording. npm `latest` points to `0.2.18`; the previous GitHub Release remains [v0.2.17](https://github.com/GGULBAE/react-native-image-compression-kit/releases/tag/v0.2.17).

The `0.2.17` registry tarball is immutable and still reflects pre-publish candidate wording. The `0.2.18` package corrects that package-page README state without runtime code or public API changes.
