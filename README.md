...
<p align="center">
  <img alt="Status: v0.2.10 published" src="https://img.shields.io/badge/Status-v0.2.10%20published-blue" />
...
Version `0.2.10` is published for `react-native-image-compression-kit`. It adds capability-gated iOS AVIF input through ImageIO static decode while keeping AVIF output, animated AVIF preservation, HEIC/HEIF output, iOS metadata preservation, cancellation, and progress outside this release. The latest published npm package is `0.2.10`, with GitHub Release [v0.2.10](https://github.com/GGULBAE/react-native-image-compression-kit/releases/tag/v0.2.10).
