# Work around intermittent CocoaPods Pathname#realdirpath failures when
# generating file references for pnpm-symlinked local pods.
module RNICKCocoaPodsPathnameWorkaround
...
Pod::Project.prepend(RNICKCocoaPodsPathnameWorkaround)
